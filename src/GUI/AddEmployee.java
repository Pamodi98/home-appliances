...
Connection conn=null;
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/images/icons8_Add_User_Male_64px_2.png"))); // NOI18N
        ...
        txtEmpId.setBackground(new java.awt.Color(0, 0, 51));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtContactNumber, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
    ...
    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpActionPerformed
        ...
        EmpEmail = txtEmail.getText();
        EmpContact = txtContactNumber.getText();
        ...
        System.out.println(EmpEmail);
         System.out.println(EmpContact);
          ...
          try{
          sql = "Insert into empdetails values ('"+EmpId+"','"+EmpName+"','"+Salutation+"','"+EmpEmail+"','"+EmpContact+"')";
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try{
            sql1 = "SELECT EmpId From empdetails ORDER BY EmpID DESC LIMIT 1";
            ...
            converted = Integer.toString(Empid);
        }
