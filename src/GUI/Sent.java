...
public class Sent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/images/icons8_Sent_64px_1.png"))); // NOI18N
        ...
        txtDeliveryNumber.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDeliveryNumberActionPerformed(evt);
            }
        });
        ...
        txtDate1.setBackground(new java.awt.Color(0, 0, 51));
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtItemNum, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void txtDeliveryNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDeliveryNumberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDeliveryNumberActionPerformed

    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpActionPerformed

        EmpId = cmbBox.getSelectedItem().toString();
        ItemNum = txtItemNum.getText();
        ItemDate = txtDate.getText();
        DeliveryNum = txtDeliveryNumber.getText();
        ItemDueDate = txtDueDate.getText();
        ...
        try{
            sql = "Insert into sent values ('"+EmpId+"','"+ItemNum+"','"+ItemDate+"','"+ItemDueDate+"','"+DeliveryNum+"')";
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtDate.setText(dateFormat.format(date1)); 
